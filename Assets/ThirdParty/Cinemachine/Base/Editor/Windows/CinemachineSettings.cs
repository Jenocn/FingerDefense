...
namespace Cinemachine.Editor
{
    ...
    internal sealed class CinemachineSettings
    {
        ...
        [SettingsProvider]
        private static SettingsProvider CinemachineSettingsGUI() {
            var provider = new SettingsProvider("Cinemachine", SettingsScope.User);
            if (provider != null) {
                provider.guiHandler = (string value)=>{
                    _OnGUI();
                };
            }
            return provider;
